  ...
  return (
    <>
      <div className="max-w-4xl mx-auto text-center my-20">
        <p className="animate-bounce text-3xl text-blue-600 pt-4 sm:text-4xl font-bold dark:text-blue-400">
          EDUCATION
        </p>
        <div className="flex flex-wrap justify-center pt-2">
          ...
          <div className="flex flex-col w-72 p-10 m-6 bg-white shadow-2xl sm:w-56 rounded-xl ">
            ...
            <p className="mt-4 text-xl font-medium ">Percentage: 82.5 / 100</p>
            <p className="mt-3 font-normal ">
