  ...
  return (
    <>
      <div className="fixed top-0 py-5 w-full flex justify-between ">
        ...
        <span className="mr-14 mt-2 text-base md:text-xl font-light">
          <a
            href="https://devutkarsh7565.github.io/resume/"
            className="md:px-4 md:py-3 px-2 py-1 rounded-xl bg-blue-600 text-white dark:bg-white dark:text-blue-600 border-3 dark:border-gray-200 hover:bg-blue-800 dark:hover:bg-gray-200 "
          >
            Resume
          </a>
        </span>
